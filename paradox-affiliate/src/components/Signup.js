...
export function Signup () {
  return (
    <div className="check-box">
        ...
        <a href={info.links.huobi} target="_blank" className="link"><p className="text">SIGN UP LINK</p></a> 
        ...
        <a href={info.links.bybit} target="_blank" className="link"><p className="text">SIGN UP LINK</p></a>
        ...
        <a href={info.links.paradoxtg} target="_blank" className="link"><p className="text">JOIN LINK</p></a>
